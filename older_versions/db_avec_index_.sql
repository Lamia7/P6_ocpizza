...
CREATE INDEX `fk_purchase_client_idx` ON `ocpizza`.`purchase` (`client_id` ASC);

CREATE INDEX `fk_order_restaurant_idx` ON `ocpizza`.`purchase` (`restaurant_id` ASC);
...
CREATE INDEX `fk_ingredient_recipe_idx` ON `ocpizza`.`ingredient` (`recipe_id` ASC, `recipe_ingredient_id` ASC);
